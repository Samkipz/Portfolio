...
export default function ProfileHeader() {
  return (
    <div className="flex flex-col sm:flex-row sm:items-center gap-8 w-full border-b pb-8 relative glass shadow-md px-6 py-6 sticky top-0 z-50 backdrop-blur-lg">
